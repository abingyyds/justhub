import{cM as P,ds as l,cP as w,cQ as I,cR as A,d6 as v,cY as h,cS as u,dc as z,d3 as R,c$ as $,d8 as M,dB as K,d4 as F,d5 as Q,cN as O,cO as q,dV as L}from"./index-BCm5JItX.js";import{S as r}from"./SwapController-DghKmMOT.js";import"./index-SLqaKc8t.js";const H={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),c=a==="a",C=a==="c",V=a==="v",W=a==="x",E=i===",",_=i===".",N=i>="0"&&i<="9";!s&&(c||C||V||W)&&e.preventDefault(),t==="0"&&!E&&!_&&i==="0"&&e.preventDefault(),t==="0"&&N&&(o(i),e.preventDefault()),(E||_)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!N&&!n.includes(i)&&!_&&!E&&e.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
...
`;var m=function(e,t,o,n){var s=arguments.length,i=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(i=(s<3?a(i):s>3?a(t,o,i):a(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let d=class extends A{subscribe({resetSwapState:t,initializeSwapState:o}){return()=>{v.subscribeKey("activeCaipNetwork",n=>this.onCaipNetworkChange({newCaipNetwork:n,resetSwapState:t,initializeSwapState:o})),v.subscribeChainProp("accountState",n=>{this.onCaipAddressChange({newCaipAddress:n?.caipAddress,resetSwapState:t,initializeSwapState:o})})}}constructor(){super(),this.unsubscribe=[],this.initialParams=$.state.data?.swap,this.detailsOpen=!1,this.caipAddress=v.getAccountData()?.caipAddress,this.caipNetworkId=v.state.activeCaipNetwork?.caipNetworkId,this.initialized=r.state.initialized,this.loadingQuote=r.state.loadingQuote,this.loadingPrices=r.state.loadingPrices,this.loadingTransaction=r.state.loadingTransaction,this.sourceToken=r.state.sourceToken,this.sourceTokenAmount=r.state.sourceTokenAmount,this.sourceTokenPriceInUSD=r.state.sourceTokenPriceInUSD,this.toToken=r.state.toToken,this.toTokenAmount=r.state.toTokenAmount,this.toTokenPriceInUSD=r.state.toTokenPriceInUSD,this.inputError=r.state.inputError,this.fetchError=r.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document?.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{!this.sourceToken||!this.toToken||(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=M.debounce(async()=>{await r.swapTokens()},200),this.subscribe({resetSwapState:!0,initializeSwapState:!1})(),this.unsubscribe.push(this.subscribe({resetSwapState:!1,initializeSwapState:!0}),K.subscribeKey("open",t=>{t||r.resetState()}),$.subscribeKey("view",t=>{t.includes("Swap")||r.resetValues()}),r.subscribe(t=>{this.initialized=t.initialized,this.loadingQuote=t.loadingQuote,this.loadingPrices=t.loadingPrices,this.loadingTransaction=t.loadingTransaction,this.sourceToken=t.sourceToken,this.sourceTokenAmount=t.sourceTokenAmount,this.sourceTokenPriceInUSD=t.sourceTokenPriceInUSD,this.toToken=t.toToken,this.toTokenAmount=t.toTokenAmount,this.toTokenPriceInUSD=t.toTokenPriceInUSD,this.inputError=t.inputError,this.fetchError=t.fetchError,t.sourceToken&&t.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){r.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(t=>t?.()),clearInterval(this.interval),document?.removeEventListener("visibilitychange",this.visibilityChangeHandler)}render(){return u`
    ...
    </wui-flex>`}async onSwitchTokens(){await r.switchTokens()}async onSwapPreview(){this.fetchError&&await r.swapTokens(),R.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:this.sourceToken?.symbol||"",swapToToken:this.toToken?.symbol||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:F(v.state.activeChain)===Q.ACCOUNT_TYPES.SMART_ACCOUNT}}),$.push("SwapPreview")}async handleSwapParameters(){this.initialParams&&(r.state.initialized||await new Promise(o=>{const n=r.subscribeKey("initialized",s=>{s&&(n?.(),o())})}),await this.setSwapParameters(this.initialParams))}async setSwapParameters({amount:t,fromToken:o,toToken:n}){(!r.state.tokens||!r.state.myTokensWithBalance)&&await new Promise(a=>{const c=r.subscribeKey("myTokensWithBalance",C=>{C&&C.length>0&&(c?.(),a())});setTimeout(()=>{c?.(),a()},5e3)});const s=[...r.state.tokens||[],...r.state.myTokensWithBalance||[]];if(o){const i=s.find(a=>a.symbol.toLowerCase()===o.toLowerCase());i&&r.setSourceToken(i)}if(n){const i=s.find(a=>a.symbol.toLowerCase()===n.toLowerCase());i&&r.setToToken(i)}t&&!isNaN(Number(t))&&r.setSourceTokenAmount(t)}onCaipAddressChange({newCaipAddress:t,resetSwapState:o,initializeSwapState:n}){this.caipAddress!==t&&(this.caipAddress=t,o&&r.resetState(),n&&r.initializeState())}onCaipNetworkChange({newCaipNetwork:t,resetSwapState:o,initializeSwapState:n}){this.caipNetworkId!==t?.caipNetworkId&&(this.caipNetworkId=t?.caipNetworkId,o&&r.resetState(),n&&r.initializeState())}};d.styles=ee;m([w({type:Object})],d.prototype,"initialParams",void 0);m([l()],d.prototype,"interval",void 0);m([l()],d.prototype,"detailsOpen",void 0);m([l()],d.prototype,"caipAddress",void 0);m([l()],d.prototype,"caipNetworkId",void 0);m([l()],d.prototype,"initialized",void 0);m([l()],d.prototype,"loadingQuote",void 0);m([l()],d.prototype,"loadingPrices",void 0);m([l()],d.prototype,"loadingTransaction",void 0);m([l()],d.prototype,"sourceToken",void 0);m([l()],d.prototype,"sourceTokenAmount",void 0);m([l()],d.prototype,"sourceTokenPriceInUSD",void 0);m([l()],d.prototype,"toToken",void 0);m([l()],d.prototype,"toTokenAmount",void 0);m([l()],d.prototype,"toTokenPriceInUSD",void 0);m([l()],d.prototype,"inputError",void 0);m([l()],d.prototype,"fetchError",void 0);m([l()],d.prototype,"lastTokenPriceUpdate",void 0);d=m([I("w3m-swap-view")],d);const te=P`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
