import{cX as Y,cR as g,dB as W,dy as K,cS as c,de as _,dr as V,dN as G,ds as l,cQ as w,cM as E,cN as U,cO as H,cP as d,dc as N,d6 as h,dO as j,d2 as k,d4 as C,d5 as m,d1 as L,dP as X,dh as q,cT as Q,dQ as v,d8 as z,dR as O,cV as Z,d3 as P,d0 as J,dS as ee,c$ as te}from"./index-DGlFY1M8.js";const ie=Y`
  div {
    width: 100%;
  }
...
`;var F=function(e,t,i,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};const I=600,M=360,oe=64;let R=class extends g{constructor(){super(),this.bodyObserver=void 0,this.unsubscribe=[],this.iframe=document.getElementById("w3m-iframe"),this.ready=!1,this.unsubscribe.push(W.subscribeKey("open",t=>{t||this.onHideIframe()}),W.subscribeKey("shake",t=>{t?this.iframe.style.animation="w3m-shake 500ms var(--apkt-easings-ease-out-power-2)":this.iframe.style.animation="none"}))}disconnectedCallback(){this.onHideIframe(),this.unsubscribe.forEach(t=>t()),this.bodyObserver?.unobserve(window.document.body)}async firstUpdated(){await this.syncTheme(),this.iframe.style.display="block";const t=this?.renderRoot?.querySelector("div");this.bodyObserver=new ResizeObserver(i=>{const r=i?.[0]?.contentBoxSize?.[0]?.inlineSize;this.iframe.style.height=`${I}px`,t.style.height=`${I}px`,K.state.enableEmbedded?this.updateFrameSizeForEmbeddedMode():r&&r<=430?(this.iframe.style.width="100%",this.iframe.style.left="0px",this.iframe.style.bottom="0px",this.iframe.style.top="unset",this.onShowIframe()):(this.iframe.style.width=`${M}px`,this.iframe.style.left=`calc(50% - ${M/2}px)`,this.iframe.style.top=`calc(50% - ${I/2}px + ${oe/2}px)`,this.iframe.style.bottom="unset",this.onShowIframe())}),this.bodyObserver.observe(window.document.body)}render(){return c`<div data-ready=${this.ready} id="w3m-frame-container"></div>`}onShowIframe(){const t=window.innerWidth<=430;this.ready=!0,this.iframe.style.animation=t?"w3m-iframe-zoom-in-mobile 200ms var(--apkt-easings-ease-out-power-2)":"w3m-iframe-zoom-in 200ms var(--apkt-easings-ease-out-power-2)"}onHideIframe(){this.iframe.style.display="none",this.iframe.style.animation="w3m-iframe-fade-out 200ms var(--apkt-easings-ease-out-power-2)"}async syncTheme(){const t=_.getAuthConnector();if(t){const i=V.getSnapshot().themeMode,n=V.getSnapshot().themeVariables;await t.provider.syncTheme({themeVariables:n,w3mThemeVariables:G(n,i)})}}async updateFrameSizeForEmbeddedMode(){const t=this?.renderRoot?.querySelector("div");await new Promise(n=>{setTimeout(n,300)});const i=this.getBoundingClientRect();t.style.width="100%",this.iframe.style.left=`${i.left}px`,this.iframe.style.top=`${i.top}px`,this.iframe.style.width=`${i.width}px`,this.iframe.style.height=`${i.height}px`,this.onShowIframe()}};R.styles=ie;F([l()],R.prototype,"ready",void 0);R=F([w("w3m-approve-transaction-view")],R);const ne=E`
  a {
    border: none;
...
`;var T=function(e,t,i,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let b=class extends g{constructor(){super(...arguments),this.name="",this.registered=!1,this.loading=!1,this.disabled=!1}render(){return c`
    ...
    `}templateRightContent(){return this.loading?c`<wui-loading-spinner size="lg" color="primary"></wui-loading-spinner>`:this.registered?c`<wui-tag variant="info" size="sm">Registered</wui-tag>`:c`<wui-tag variant="success" size="sm">Available</wui-tag>`}};b.styles=[U,H,ce];T([d()],b.prototype,"name",void 0);T([d({type:Boolean})],b.prototype,"registered",void 0);T([d({type:Boolean})],b.prototype,"loading",void 0);T([d({type:Boolean})],b.prototype,"disabled",void 0);b=T([w("wui-account-name-suggestion-item")],b);const de=E`
  :host {
    position: relative;
    width: 100%;
...
`;var S=function(e,t,i,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let f=class extends g{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return c`
      ...
      ></wui-input-text>
    `}};f.styles=[U,de];S([d()],f.prototype,"errorMessage",void 0);S([d({type:Boolean})],f.prototype,"disabled",void 0);S([d()],f.prototype,"value",void 0);S([d({type:Boolean})],f.prototype,"loading",void 0);S([d({attribute:!1})],f.prototype,"onKeyDown",void 0);f=S([w("wui-ens-input")],f);const le=E`
  wui-flex {
    width: 100%;
  }
...
`;var x=function(e,t,i,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let p=class extends g{constructor(){super(),this.formRef=Q(),this.usubscribe=[],this.name="",this.error="",this.loading=v.state.loading,this.suggestions=v.state.suggestions,this.profileName=h.getAccountData()?.profileName,this.onDebouncedNameInputChange=z.debounce(t=>{t.length<4?this.error="Name must be at least 4 characters long":O.isValidReownName(t)?(this.error="",v.getSuggestions(t)):this.error="The value is not a valid username"}),this.usubscribe.push(v.subscribe(t=>{this.suggestions=t.suggestions,this.loading=t.loading}),h.subscribeChainProp("accountState",t=>{this.profileName=t?.profileName,t?.profileName&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(t=>t()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return c`
    ...
    </wui-flex>`}isAllowedToSubmit(t){const i=t.split(".")?.[0],n=this.suggestions.find(r=>r.name?.split(".")?.[0]===i&&r.registered);return!this.loading&&!this.error&&!this.profileName&&i&&v.validateName(i)&&!n}async onSubmitName(t){try{if(!this.isAllowedToSubmit(t))return;P.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:C(h.state.activeChain)===m.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t}}),await v.registerName(t),P.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:C(h.state.activeChain)===m.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t}})}catch(i){J.showError(i.message),P.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:C(h.state.activeChain)===m.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t,error:z.parseError(i)}})}}onEnterKey(t){if(t.key==="Enter"&&this.name&&this.isAllowedToSubmit(this.name)){const i=`${this.name}${k.WC_NAME_SUFFIX}`;this.onSubmitName(i)}}};p.styles=le;x([d()],p.prototype,"errorMessage",void 0);x([l()],p.prototype,"name",void 0);x([l()],p.prototype,"error",void 0);x([l()],p.prototype,"loading",void 0);x([l()],p.prototype,"suggestions",void 0);x([l()],p.prototype,"profileName",void 0);p=x([w("w3m-register-account-name-view")],p);const ue=Y`
...
`;var pe=function(e,t,i,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let D=class extends g{render(){return c`
    ...
    </wui-flex>`}redirectToAccount(){te.replace("Account")}};D.styles=ue;D=pe([w("w3m-register-account-name-success-view")],D);export{R as W3mApproveTransactionView,D as W3mRegisterAccountNameSuccess,p as W3mRegisterAccountNameView,$ as W3mSmartAccountSettingsView,B as W3mUpgradeWalletView};
